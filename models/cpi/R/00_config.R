...
PATHS <- list(
  ...
  output_root = file.path(PROJECT_ROOT, "cpi", "outputs"),
  tables    = file.path(PROJECT_ROOT, "cpi", "outputs", "tables"),
  figures   = file.path(PROJECT_ROOT, "cpi", "outputs", "figures")
)

# Ensure output directories exist
for (d in PATHS[c("output_root", "tables", "figures")]) {
