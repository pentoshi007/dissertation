# ==============================================================================
# run_all.R — Master orchestrator for CPI pipeline
# ==============================================================================
# Title: Oil Price Pass-Through to India's CPI Inflation (2004-2024)
# Author: Aniket Pandey | JNU MS Economics 2026
# Pipeline: CPI pass-through models
#
# Usage:
#   cd /Users/aniketpandey/Desktop/fresh-dissertation/models
#   Rscript cpi/run_all.R
#
...
cat("\n")
cat("================================================================\n")
cat("  CPI PIPELINE — FULL RUN\n")
cat("  Oil Price Pass-Through to India's CPI Inflation, 2004-2024\n")
cat("  Model hierarchy: M1 headline | PPAC mechanism | M2 robustness\n")
cat("================================================================\n")
...
modules <- c(
  "cpi/R/00_config.R",
  "cpi/R/01_helpers.R",
  "cpi/R/02_data_loader.R",
  "cpi/R/03_variable_builder.R",
  "cpi/R/04_descriptives.R",
  "cpi/R/05_unit_roots.R",
  "cpi/R/06_models.R",
  "cpi/R/06b_granger.R",
  "cpi/R/07_diagnostics.R",
  "cpi/R/08_bootstrap.R",
  "cpi/R/09_mechanism_chain.R",
  "cpi/R/09b_attenuation_test.R",
  "cpi/R/10_robustness.R",
  "cpi/R/11_figures.R",
  "cpi/R/12_publication_triage.R"
)
...
# ── Dilution chain ───────────────────────────────────────────────────────────
cat("\n  === DILUTION HYPOTHESIS ===\n")
dil_file <- file.path(PATHS$tables, "table_23_dilution_hypothesis.csv")
...
att_file <- file.path(PATHS$tables, "table_23c_attenuation_wald.csv")
...
# ── Granger causality ────────────────────────────────────────────────────────
cat("\n  === GRANGER CAUSALITY ===\n")
grg_file <- file.path(PATHS$tables, "table_10b_granger_causality.csv")
...
# ── Diagnostics triage ───────────────────────────────────────────────────────
cat("\n  === DIAGNOSTIC TRIAGE ===\n")
diag_file <- file.path(PATHS$tables, "table_09_diagnostics_all.csv")
